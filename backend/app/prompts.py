def coach_system_prompt():
    return (
        ...
        "Return JSON with keys: 'summary', 'coaching_advice', 'stats', 'actions', 'risks', 'next_inputs'. "
        "Keep summary under 200 chars. Coaching_advice should be 1-2 sentences of conversational, encouraging advice. "
