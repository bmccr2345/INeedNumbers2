...
# ============================================================================
# OLD AUTH FUNCTIONS REMOVED - NOW USING CLERK AUTH
...
# ============================================
from app.models.onboarding_profile import OnboardingProfile, OnboardingSaveRequest
from app.services.onboarding_service import save_onboarding_data, complete_onboarding
...
async def save_onboarding(
    ...
    try:
        ...
        return {"success": True, "profile": profile_data, "message": "Onboarding data saved successfully"}
...
async def complete_onboarding_flow(user=Depends(get_current_user_unified)):
    """Complete onboarding and initialize user dashboard"""
    try:
        result = await complete_onboarding(db, user.id)
        return {"profile": result["profile"], "dashboard": result["dashboard"]}
    except ValueError as e:
...
async def get_onboarding_status(user=Depends(get_current_user_unified)):
...
logger.info("Onboarding endpoints registered inline")
