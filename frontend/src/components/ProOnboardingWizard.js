    ...
    1: {
      ...
      tasks: [
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-blue-50/80 p-4 rounded-lg border border-blue-200 mt-4">
                ...
                <div className="flex gap-2">
                  <button 
                    onClick={() => updateDay1Input('goalSentiment', 'Too high')}
                    className={`px-4 py-2 border border-blue-200 rounded-md text-xs hover:bg-blue-100 transition-colors ${
                      day1Inputs.goalSentiment === 'Too high' ? 'bg-blue-200 font-semibold' : 'bg-white'
                    }`}
                  >
                    Too high
                  </button>
                  <button 
                    ...
                    className={`px-4 py-2 border rounded-md text-xs hover:bg-emerald-100 transition-colors ${
                  ...
                  <button 
                    onClick={() => updateDay1Input('goalSentiment', 'Too low')}
                    className={`px-4 py-2 border border-blue-200 rounded-md text-xs hover:bg-blue-100 transition-colors ${
                      day1Inputs.goalSentiment === 'Too low' ? 'bg-blue-200 font-semibold' : 'bg-white'
                    }`}
                  >
                    Too low
                  </button>
                </div>
                {day1Inputs.goalSentiment && (
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3 text-sm">
              <p className="font-medium"><span className="font-bold text-emerald-600">I Need Numbers</span> turns your activity into insight:</p>
